...
revealPath({direction: "North", distance: 10});
...
function mixPotion({ingredient1 = "Water", ingredient2 = "Fireflower"} = {}) {
    console.log(`Mix potion with: ${ingredient1} and ${ingredient2}.`);
}
...
function castSpell(ingredients) {
    ...
    console.log(`Cast your spell with: ${firstIngredient} and ${secondIngredient}.`);
}
castSpell(["Mandrake", "Unicorn Hair", "Phoenix Feather"]);
...
console.log(`Ultimate Clue: ${finalKey}`);
